    ...
    <div className='space-y-5'>
            ...
            <div className="flex flex-col items-center">
              <div className="flex-1 space-y-4">
                <div className="w-full grid grid-cols-10 gap-x-3">
                  {seatLayout.slice(0, 10)}
                </div>
                <div className="w-full grid grid-cols-10 gap-x-3">
                  {seatLayout.slice(10, 20)}
                </div>
                <div className="w-full grid grid-cols-10 gap-x-3">
                  <div className="col-span-9"></div>
                  {seatLayout.slice(20, 21)}
                </div>
                <div className="w-full grid grid-cols-10 gap-x-3">
                  {seatLayout.slice(21, 31)}
                </div>
                <div className="w-full grid grid-cols-10 gap-x-3">
                  {seatLayout.slice(31, 41)}
                </div>
              </div>
            </div>
          </div>
      ...
      {selectedSeats.length > 0 && (
        <div className="!mt-5 flex items-center gap-x-4">
          ...
          <p className="text-lg font-medium">${selectedSeats.length * 750}</p>

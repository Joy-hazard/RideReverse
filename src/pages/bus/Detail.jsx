    ...
    <div className='w-full lg:px-28 md:px-16 sm:px-7 px-4 mt-[13ch] mb-[10ch]'>
      <div className='w-full grid grid-cols-2 gap-16 items-center'>
        <div className='col-span-1 space-y-8'>
          <img src={Bus} alt='Luxury bus image' className='w-full aspect-[3/2] rounded-md object-contain' />
          <div className='space-y-4'>
            ...
            <p className='text-neutral-900 dark:text-neutral-200 text-sm font-normal'>
              Hey developers! Welcome to G-Tech Official channel. In this tutorial, we'll embark on an exciting journey to build a fully Online Ticket Booking System using ReactJs and Tailwind CSS. Whether you're a beginner or an experienced coder
            </p>
          </div>
        </div>

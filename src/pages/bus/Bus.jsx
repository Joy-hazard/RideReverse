    ...
    <div className='w-full lg:px-28 md:px-16 sm:px-7 px-4 mt-[13ch] mb-[8ch] space-y-14'>
      ...
      <div className='w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10'>
        <Link to={'/bus/bus-details'} className='w-full bg-neutral-200/60 block dark:bg-neutral-900/40 rounded-xl p-4'>
          <img src={Bus1} alt='Tourist Bus Image' className='w-full aspect-video object-contain object-center' />
        ...
        <Link to={'/bus/bus-details'} className='w-full bg-neutral-200/60 block dark:bg-neutral-900/40 rounded-xl p-4'>
          <img src={Bus2} alt='Private Bus Image' className='w-full aspect-video object-contain object-center' />
          <div className='px-3 py-4 space-y-2'>
            <div className='flex items-center justify-between'>
              <h1 className='text-xl font-semibold text-neutral-800 dark:text-neutral-50'>Private Bus</h1>
              <p className='text-sm font-normal text-neutral-800 dark:text-neutral-50'>50 Passengers</p>
            </div>
          </div>
        </Link>
        <Link to={'/bus/bus-details'} className='w-full bg-neutral-200/60 block dark:bg-neutral-900/40 rounded-xl p-4'>
          <img src={Bus3} alt='Luxury Bus Image' className='w-full aspect-video object-contain object-center' />
          <div className='px-3 py-4 space-y-2'>
            <div className='flex items-center justify-between'>
              <h1 className='text-xl font-semibold text-neutral-800 dark:text-neutral-50'>Luxury Bus</h1>
              <p className='text-sm font-normal text-neutral-800 dark:text-neutral-50'>45 Passengers</p>
            </div>
          </div>
        </Link>
        <Link to={"/bus/bus-details"} className="w-full bg-neutral-200/60 block dark:bg-neutral-900/40 rounded-xl p-4">
        ...
        {/* Add remaining bus cards similarly */}
      </div>
    </div>
  );
};
